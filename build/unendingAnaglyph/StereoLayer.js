class StereoLayer {
  ...
  update( rate ) {
    ...
    this.leftImage.position.y = 2 + this.originalY + Math.pow((this.position.z+15) * 0.03, 2);
    this.rightImage.position.y = 2 + this.originalY + Math.pow((this.position.z+15) * 0.03, 2);
