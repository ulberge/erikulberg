      ...
      <div className={classnames(className, 'container')}>
        <div className="col-md-8 col-md-offset-2">
          ...
          <div className="row">
            <h4>Statement:</h4>
            <div>
              <p>Erik Ulberg is an <b>artist</b> and <b>programmer</b> interested in using <b>software</b>, <b>physical computing</b>, <b>speculative design</b> and <b>machine learning</b> to design custom tools for <b>visual art</b>, <b>landscape architecture</b>, and <b>language learning</b>.
              </p>
            </div>
          </div>
