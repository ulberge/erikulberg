      ...
      <div className={classnames(className, 'container projectPage')}>
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <p>I had an interest in garden design from when I took classes in Landscape Horticulture at South Seattle College and worked part-time as a gardener. I wanted to experiment with the use of size, shape, and color in different combinations by creating a tool that rapidly iterated over possibilities.</p>
