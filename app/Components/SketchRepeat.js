      ...
      <div className="container-fluid projectPage">
        ...
        <div className="accentRow row">
          <div className="container">
            ...
            <p>Matching happens at different levels of abstraction by matching activations at different layers of a pre-trained <a href="http://sketchx.eecs.qmul.ac.uk/downloads/">Sketch-A-Net</a>, a convolutional neural network. </p>
