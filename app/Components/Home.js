  ...
  render() {
    return (
      <div className={classnames(className, 'container')}>
        <div className="row">
          <Tile title="My Two Other Faces" year="2019" subtitle="Face Recognition Mirror" img="./imgs/home/mytwootherfaces_still.jpg" gif="./imgs/home/mytwootherfaces.gif" absoluteLink="/projects/MyTwoOtherFaces/" styleName="col-md-4" />
