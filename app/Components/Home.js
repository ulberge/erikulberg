  ...
  render() {
    return (
      <div className={classnames(className, 'container')}>
        <div className="row">
          <Tile title="ScriptSketch" year="2018" subtitle="Scripting + CAD" img="./imgs/icons/scriptsketch.jpg" link="/scriptsketch" styleName="col-md-3" />
        ...
        <div className="homeLink" className="row">
          ...
          <Tile title="Huckleberry Processor" year="2016-2017" subtitle="Fabrication + Horticulture" img="./imgs/icons/huckleberry.jpg" link="/huckleberry" styleName="col-md-3" />
        </div>
      </div>
    );
  }
