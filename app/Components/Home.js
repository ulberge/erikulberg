  ...
  render() {
    return (
      <div className={classnames(className, 'container')}>
        <div className="row">
          <Tile title="Hand Drawn Effect in AARON" year="2019" subtitle="AI Art" img="./imgs/home/aaron_first.gif" gif="./imgs/home/aaron.gif" absoluteLink="/projects/handDraw/" styleName="col-md-4" />
          <Tile title="A Conversation with a Machine" year="2019" subtitle="CV + ML" img="./imgs/home/mldraw_first.gif" gif="./imgs/home/mldraw_rollover.gif" link="/conversationwithamachine" styleName="col-md-4" />
