    ...
    return (
      <div className={classnames(className, 'container')}>
        ...
        <div className="homeLink" className="row">
          ...
          <Tile title="Huckleberry Processor" year="2016-2017" subtitle="Mechanical Eng + Wild Farming" img="./imgs/icons/huckleberry.jpg" link="/huckleberry" styleName="col-md-3" />
        </div>
      </div>
    );
  }
