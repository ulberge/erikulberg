...
module.exports = React.createClass({
  componentDidMount: function componentDidMount() {
    const garden = $('#iframe');
    garden.width('100%');
    garden.height(garden.width() * 0.4);
    garden.focus();
  },
      ...
      <div className={classnames(className, 'container projectPage')}>
        ...
        <div className="row">
          ...
          <div className="col-md-12">
            <div className="well">
              <b>CONTROLS:</b> (First click on video) <span className="text-info">toggle between stereo and anaglyph</span>: &lt;space bar&gt;
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-md-8 col-md-offset-2">
            ...
            <p>Endless Stereograph is a 3D animation composed of endlessly repeating stereoscopic images of a forest path. The project consists of stereoscopic images with transparent holes cut out, layered in a virtual 3D space, and moving toward the viewer in a curved plane.</p>
            <div className="">
